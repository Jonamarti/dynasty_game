...
| **M11 phase 10, continued, and phase 11** | **next.** `dairying`, `wool`, `brewing`, `well` — `wool`/`dairying` depend on `herding` (now shipped) — then war. See [m8_plan_the_ages.md](m8_plan_the_ages.md) |
