...
- The owner's decision on `bands-take-sides` in well-fed worlds remains open. The `farmers` and `stewards` cohorts provide 8 eligible worlds each, with 4 and 5 spreads respectively, but not enough evidence to answer the normative question. `crowded` has thin forage and does not measure the well-fed case.
