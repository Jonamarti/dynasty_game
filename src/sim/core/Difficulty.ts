...
export const DIFFICULTIES: Record<DifficultyId, Record<string, number>> = {
  peaceful: {
    ...
    'world.fishingSpots': 76, 'world.treeDensity': 0.78, 'world.deadwood': 225,
  ...
  easy: {
    ...
    'world.fishingSpots': 61, 'world.treeDensity': 0.65, 'world.deadwood': 182,
  ...
  normal: {
    ...
    'world.fishingSpots': 50, 'world.treeDensity': 0.55, 'world.deadwood': 150,
  ...
  hard: {
    ...
    'world.fishingSpots': 37, 'world.treeDensity': 0.44, 'world.deadwood': 112,
  ...
  extreme: {
    ...
    'world.fishingSpots': 27, 'world.treeDensity': 0.34, 'world.deadwood': 83,
